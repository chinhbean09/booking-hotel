...
//    }
    ...
    public HotelResponse uploadImages(List<MultipartFile> images, Long hotelId) throws IOException, PermissionDenyException, DataNotFoundException {
        ...
        for (MultipartFile image : images) {
            ...
            String imageUrl = uploadImageToCloudinary(image, hotelId);
    ...
    public HotelResponse updateHotelImages(Map<Integer, MultipartFile> imageMap, Long hotelId) throws IOException, PermissionDenyException, DataNotFoundException {
        ...
        for (Map.Entry<Integer, MultipartFile> entry : imageMap.entrySet()) {
            ...
            if (optionalRoomImage.isPresent()) {
                ...
                String imageUrl = uploadImageToCloudinary(imageFile, hotelId);
    ...
    private String uploadImageToCloudinary(MultipartFile imageFile, Long hotelId) throws IOException {
        Map uploadResult = cloudinary.uploader().upload(imageFile.getBytes(),
                ObjectUtils.asMap("folder", "hotel_images/" + hotelId));
    ...
    private void deleteImageFromCloudinary(String imageUrl) {
        try {
            ...
            cloudinary.uploader().destroy("hotel_images/" + publicId, ObjectUtils.emptyMap());
        } catch (Exception e) {
